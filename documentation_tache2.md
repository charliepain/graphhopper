...
La méthode retire les doublons consécutifs entre 0 et `end` exclusivement.
...
Après les nouveaux tests:
<img title="a title" alt="Alt text" src="mutations/images/mutant1_nouveau.png">
La mutation se produit sur une condition dans la méthode [`ArrayUtil.merge(int[] a, int[] b)`](core/src/main/java/com/graphhopper/util/ArrayUtil.java).
